        ...
        >
            ...
            <div className="flex items-center justify-between p-4 border-b border-white/12 shrink-0">
                <div className="flex items-center gap-2">
                    ...
                    <Label className="text-white/80 font-medium text-sm">Design Chat</Label>
                </div>
            ...
            <div className='p-4 border-t border-white/12 shrink-0'>
                <div className="space-y-3">
                    ...
                    <div className="text-xs text-white/60 text-center">Type your redesign request and <strong> press Enter</strong></div>
                </div>
            </div>
        </div>
    )
